          ...
          children: [
            Icon(
              ...
              size: ResponsiveHelper.getIconSize(context,
                mobileSize: 64, tabletSize: 80, desktopSize: 90),
              color: Colors.grey[400],
            ),
            SizedBox(height: ResponsiveHelper.getSpacing(context,
              mobileSpacing: 18, tabletSpacing: 24, desktopSpacing: 28)),
            Text(
              'لم يتم تعيين سيارة',
              style: TextStyle(
                fontSize: ResponsiveHelper.getFontSize(context,
                  mobile: 17, tablet: 20, desktop: 22),
                fontWeight: FontWeight.bold,
                color: Colors.grey[600],
              ),
            ),
            SizedBox(height: ResponsiveHelper.getSpacing(context,
              mobileSpacing: 10, tabletSpacing: 12, desktopSpacing: 14)),
            Text(
  ...
  Widget _buildBusInfo() {
    return SingleChildScrollView(
      padding: ResponsiveHelper.getPadding(context,
        ...
        desktopPadding: const EdgeInsets.all(22)),
      child: Center(
