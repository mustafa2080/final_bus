...
class SimpleFCMService {
  ...
  ///
  /// بتعيد طلب صلاحية الإشعارات صراحة هنا كمان (مش بس في initialize()
  /// اللي بتتنادى مرة واحدة في main() قبل ما أي مستخدم يسجّل دخول).
  /// لو ولي الأمر رفض الصلاحية أول مرة فتح فيها التطبيق (أو الطلب ظهر
  /// وقت التطبيق كان لسه بيحمّل ومحدش شافه فعليًا)، كان التوكن بيتحفظ
  /// وبيوصله الإشعار من الباك اند عادي، لكن نظام التشغيل كان برضو
  /// بيرفض عرضه (مفيش جرس ولا صوت) لأن الصلاحية أصلاً مش ممنوحة - وده
  /// اللي كان بيدي إحساس "الإشعار وصل بس مفيش تنبيه". طلبها تاني هنا،
  /// بعد ما ولي الأمر شاف حسابه شغال وأكثر عرضة يوافق، بيغطي الحالة دي.
